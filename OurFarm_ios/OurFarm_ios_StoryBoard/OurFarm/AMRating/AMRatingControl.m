...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < _rating; i++)
	{
		...
		else
        {
            ...
            [kDefaultSolidChar drawAtPoint:currPoint withFont:[UIFont boldSystemFontOfSize:_kFontSize]];
        }
	...
	for (int i = 0; i < remaining; i++)
	{
		...
		else
        {
			...
			[kDefaultEmptyChar drawAtPoint:currPoint withFont:[UIFont boldSystemFontOfSize:_kFontSize]];
        }
		currPoint.x += kStarWidthAndHeight;
	}
}
