//
//  SummaryListTopViewController.m
//  OurFarm
//
...
#import "SummaryListTopViewController.h"
#import "SummaryCell.h"
#import "Summary.h"
#import "MapViewController.h"
#import "DetailViewController.h"

@interface SummaryListTopViewController ()

@end

@implementation SummaryListTopViewController{
...
{
    reloads_++;
    NSLog(@"start to loadtable ,reloads is:%d ");
    //请求参数
    NSDictionary *param = [NSDictionary dictionaryWithObjectsAndKeys:
                           [NSNumber numberWithInt:reloads_ + 1], @"count",nil];
    
    [Summary getHotTopSummaryWithBlock:^(NSArray *posts, NSError *error) {
        if (error) {
