...
- (id)init {
    ...
    if (self) {
        ...
        self.backgroundActionView = [[UIImageView alloc] initWithImage:backgroundImage];
...
- (void)present {
    if (self.items && self.items.count > 0) {
        ...
        UIView* actionSheet = [[UIView alloc] initWithFrame:CGRectMake(0, viewController.view.frame.size.height, viewController.view.frame.size.width, 0)];
