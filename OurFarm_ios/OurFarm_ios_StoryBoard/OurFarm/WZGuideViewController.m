...
- (void)showGuide
{
    //TODO 去掉后点击关于时显示  但是在第一次启动的时候不显示  ？？
...
- (void)viewDidLoad
{
    ...
    NSArray *imageNameArray = [NSArray arrayWithObjects:@"navigation_w01", @"navigation_w02", @"navigation_w03", @"navigation_w04", nil];
...
//            [view addSubview:checkButton];
            ...
            [enterButton setBackgroundImage:[UIImage imageNamed:@"go_farm"] forState:UIControlStateNormal];
            [enterButton setBackgroundImage:[UIImage imageNamed:@"go_farm"] forState:UIControlStateHighlighted];
