...
public class DetailCheckinActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // 去除标题栏
      ...
      //设置标题
        ...
        tvTitle.setText(R.string.detail_checkin);
        //更改底部栏字体颜色
        TextView tvname = (TextView) this.findViewById(R.id.TextView_panelBottom_detail_checkin);
