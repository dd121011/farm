...
require_once "../src/service/ServicePlans.class.php";
...
function Plays($count,$type){
	/* 通过service获取查询结果  */
	$service = new ServicePlays($count,$type);
	$Summary_array =$service->findPlans() ;
