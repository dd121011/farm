...
var activity = tables.activity,
  relation_destination_activity= tables.relation_destination_activity;
...
exports.index = function (req, res, next) {
	...
	pool.getConnection(function(err, connection) {
	  // Use the connection
	  connection.query('SELECT * from ' + activity + ' limit 0, 20', function(err, rows, fields) {
	    if (err) throw err;
	    res.render('activity/main_activity', {
	    	  title: "活动",
	    	  errmsg: "",
	    	  results: rows
	    });
...
//增加活动景点
exports.playAdd = function (req, res, next) {
	
};
//删除活动景点
exports.playDel = function (req, res, next) {
...
exports.add = function (req, res, next) {
	checkLogin(null, req, res);
	var sql = "insert into travel.' + itinerary + ' (name,classic_flag,score,hot,pic,price,price_info) " +
...
exports.scrolload = function (req, res, next) {
	...
	var sql = 'SELECT * from travel.' + itinerary + ' line where 1=1';
...
exports.updatesummary = function (req, res, next) {
  checkLogin(null, req, res);
  var sql = 'update travel.' + itinerary +
...
exports.del = function (req, res, next) {
  ...
  var sql = 'delete from travel.' + itinerary +
    ' where itinerary_id = ' + id;

  //删除路线概要
  var deleteSummarySql = 'delete from travel.' + retelation_itinerary_digraph +
    ' where itinerary_id = ' + id;
...
exports.summary = function (req, res, next) {
    ...
    var id = req.params.id;
	var pool = dbpool;
	var sql = 'SELECT * FROM travel.' + retelation_itinerary_digraph +
	  ' where itinerary_id = ' + id +
	  ' order by step_num ';
...
exports.summaryAdd = function (req, res, next) {
	checkLogin(null, req, res);
	var sql = "insert into travel." + retelation_itinerary_digraph +
...
exports.summaryEdit = function (req, res, next) {
	checkLogin(null, req, res);
	  var sql = 'update travel.' + retelation_itinerary_digraph +
...
exports.summaryDel = function (req, res, next) {
  checkLogin(null, req, res);
  var sql = 'delete from travel.' + retelation_itinerary_digraph +
    ' where itinerary_id = :itinerary_id ' +
    '  and step_num = :step_num ';
...
exports.characteristic = function (req, res, next) {
  //检测是否已经登录
  checkLogin(null, req, res);
  var sql = 'SELECT * FROM travel.' + domain_destination_type;
